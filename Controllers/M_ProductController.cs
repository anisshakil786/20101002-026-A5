...
namespace e_commerce.Controllers
{
    public class M_ProductController : Controller
    {
        ...
        {
            ViewBag.Category_FId = new SelectList(db.M_Category, "Category_Id", "Category_Name");
            return View();
        }
        ...
        public ActionResult Create(M_Product m_Product)
        {
            ...
            ViewBag.Category_FId = new SelectList(db.M_Category, "Category_Id", "Category_Name", m_Product.Category_FId);
            return View(m_Product);
        }
